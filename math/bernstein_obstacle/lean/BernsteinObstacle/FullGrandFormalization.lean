...
/-- Ordinary fixed-stage FEM convergence directly yields the full real-power
moving-obstacle grand theorem. -/
...
/-- Ordinary fixed-stage FEM convergence closes the formerly omitted
consistency-limited fractional regime. -/
...
/-- Strict stagewise coefficient clearance plus ordinary FEM convergence yields
 the full real-power moving-obstacle theorem. -/
...
/-- Strict coefficient clearance closes the real consistency-limited theorem. -/
