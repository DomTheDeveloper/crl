...
If a discrete feasible set is contained in the limit feasible set, the
continuous and discrete variational inequalities combine with any discrete
recovery point to control the full solution error by the recovery distance gap.
-/
