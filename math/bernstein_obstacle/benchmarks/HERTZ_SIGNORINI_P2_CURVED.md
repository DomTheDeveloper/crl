...
The polygonal P2 run at the same unknown count had pressure `L2` error about `2.05e-1`; curved geometry reduces that reported diagnostic by approximately 57% while retaining the same pointwise Bernstein gap certificate.
